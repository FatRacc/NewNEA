#FROM File.py IMPORT (Subroutine/Class).py
...
def ChooseNode():
    while run:
        ...
        pygame.draw.rect(screen, (0, 0, 0), (100, 0, 100, 100))
        pygame.draw.rect(screen, (255, 255, 255), (200, 0, 100, 100))
        pygame.draw.rect(screen, (0, 0, 0), (0, 100, 100, 100))
        pygame.draw.rect(screen, (255, 255, 255), (100, 100, 100, 100))
        pygame.draw.rect(screen, (0, 0, 0), (200, 100, 100, 100))
        pygame.draw.rect(screen, (255, 255, 255), (0, 200, 100, 100))
